...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'aiphucanh_de1cb27f8eb31c686413_20250507061817_archive.zip';
        const ARCHIVE_SIZE       = '140138475';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'de1cb27-07061817';
        const SECONDARY_PACKAGE_HASH = '9a489d7-07061817';
