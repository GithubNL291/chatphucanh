...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'aiphucanh_dc3e513c087070925363_20250425095839_archive.zip';
        const ARCHIVE_SIZE       = '144129129';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'dc3e513-25095839';
        const SECONDARY_PACKAGE_HASH = '8befdcd-25095839';
